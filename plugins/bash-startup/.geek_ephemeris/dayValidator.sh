...
case $DATE in
	14-03)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/pi2 | lolcat
		echo ""
		echo "Happy Pi π Day!" | lolcat
		echo ""
	;;
	25-03)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/gandalf2 | lolcat
		echo ""
		echo "Happy International Tolkien Reading Day!" | lolcat
		echo ""
	;;
	04-05)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/starwars | lolcat
		echo ""
	...
	;;
	10-05)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/garrote | lolcat
		echo ""
		...
		;;
	25-05)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/friki | lolcat
		echo ""
		echo "Happy Geek Pride Day" | lolcat
		echo ""
		;;
	19-09)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/pirata | lolcat
		echo ""
		echo "Happy International Talk Like a Pirate Day!" | lolcat
		echo ""
		;;
	29-08)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/joystick | lolcat
		echo ""
		echo "Happy world gamer day" | lolcat
		echo ""
		;;
	18-09)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/batman | lolcat
		echo ""
		echo "Happy world batman day" | lolcat
		echo ""
		;;
	28-01)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/lego | lolcat
		echo ""
		echo "Happy world lego day" | lolcat
		echo ""
		;;
	09-05)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/goku2 | lolcat
		echo ""
		echo "Happy goku day" | lolcat
		echo ""
		;;
	$PROGRAMERDAY)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/programerday | lolcat
		echo ""
		echo "Happy programmer's day" | lolcat
		echo ""
		;;
	$SYSADMINDAY)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/sysadminday | lolcat
		echo ""
		echo "Happy sysadmin day"
		echo ""
		;;
	$SMURFDAY)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/smurf.ans
		echo ""
	...
	24-05)
		echo ""
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/mariaAuxiliadora.txt | lolcat
		...
		;;
	03-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/bike.txt | lolcat
		echo ""
		...
		;;
	14-04)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/goalkepper.txt | lolcat
		echo ""
		echo 'Happy soccer goalkeeper day' | lolcat
		echo "It has been celebrated since 2013, Miguel Calero's birthday"
	;;
	21-10)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/backToTheFuture | lolcat
		echo ""
	...
	;;
	05-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/worldEnvironment | lolcat
		echo ""
	...
	;;
	04-01)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/braille.txt | lolcat
		echo ""
	...
	;;
	21-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/yoga.txt | lolcat
		echo ""
	...
	;;
	14-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/blood.txt | lolcat
		echo ""
	...
	;;
	18-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/sustainableGastronomy.txt | lolcat
		echo ""
	...
	;;
	30-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/asteroide.ans
		echo ""
	...
	;;
	09-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/donald.ans
		echo ""
	...
	;;
	06-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/yoyo.txt | lolcat
		echo ""
	...
	;;
	21-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/selfie.txt | lolcat
		echo ""
	...
	;;
	21-06)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/skate.txt | lolcat
		echo ""
	...
	;;
	22-07)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/hamaca.txt | lolcat
		echo ""
		echo 'World "Hamaca" Day' | lolcat
		echo ""
	;;
	13-01)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/depressionFight.txt | lolcat
		echo ""
	...
	;;
	10-10)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/mentalhealtyday.txt | lolcat
		echo ""
	...
	;;
	23-04)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/diadelidioma.txt | lolcat
		echo ""
	...
	16-12|17-12|18-12|19-12|20-12|21-12|22-12|23-12|24-12)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/pesebre24dic 
        echo "" 
	...
	;;
		20-01)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/worldpenguinday.txt | lolcat
		echo ""
	...
	;;
		21-01)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/hugday.txt | lolcat
		echo ""
	...
	;;
	*)
		cat ~/.oh-my-bash/custom/plugins/bash-startup/.geek_ephemeris/welcomePictures/submarine | lolcat
